...
<div id="buddypress">
	...
	<div class="page" id="register-page">
		...
		<?php if ( 'request-details' == bp_get_current_signup_step() ) : ?>
			...
			<div class="signup__details--container">
			<?php _e( '
				<p>Sign up to get access to our awesome features like:</p>
				<ul>
					<li>Our unique chatting system</li>
					<li>Rating and reviewing games</li>
					<li>Posting your scores on competitve leaderboards</li>
					<li>and much much more...</li>
				</ul>
				<p>just fill in your correct detail in to get started.</p>', 
				'buddypress' ); 
				?>
			...
			<div class="register-section" id="basic-details-section">
				...
				<label for="signup_username"><?php _e( 'Username', 'buddypress' ); ?> <?php _e( '<span style="color:red">*</span>', 'buddypress' ); ?></label>
				<?php
				...
				<label for="signup_email"><?php _e( 'Email Address', 'buddypress' ); ?> <?php _e( '<span style="color:red">*</span>', 'buddypress' ); ?></label>
				<?php
				...
				<label for="signup_password"><?php _e( 'Password', 'buddypress' ); ?> <?php _e( '<span style="color:red">*</span>', 'buddypress' ); ?></label>
				<?php
				...
				<label for="signup_password_confirm"><?php _e( 'Confirm Password', 'buddypress' ); ?> <?php _e( '<span style="color:red">*</span>', 'buddypress' ); ?></label>
				<?php
			...
			<div class="submit">
				<input type="submit" name="signup_submit" id="signup_submit" value="<?php esc_attr_e( 'Continue', 'buddypress' ); ?>" />
			</div>
		...
		<?php if ( 'completed-confirmation' == bp_get_current_signup_step() ) : ?>
			...
			<div id="template-notices" role="alert" aria-atomic="true">
				<?php if ( bp_registration_needs_activation() ) : ?>
					<p><?php _e( 'You have successfully created your account! To begin using this site you will need to activate your account via the email we have just sent to your address. Remember to check your junk emails!', 'buddypress' ); ?></p>
				<?php else : ?>
