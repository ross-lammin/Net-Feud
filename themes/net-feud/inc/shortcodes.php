...
/*
* This makes a random post appear in any caregory or tag for now, will eventually
* have different filters that can be applied.
*/
function random_game_display() {
    ...
    while ($my_query->have_posts()) : $my_query->the_post(); ?>
      ...
      <div class="category__container--game">
        <a href=" <?php get_permalink() ?>">
          ...
          <?php
          $markup = '';
          $markup .= '<h1 class="category__container--title">';
          $markup .= myarcade_title();
          $markup .=$markup .= '</h1>';
          $markup .= myarcade_thumbnail();
          $markup .= '<div>';
          $markup .= '<p>';
          $markup .= myarcade_excerpt( 100 );
          $markup .= '</p>';
          $markup .= '</div';
          echo $markup;
          ?>
...
add_shortcode( 'rand_game_display', 'random_game_display' );
