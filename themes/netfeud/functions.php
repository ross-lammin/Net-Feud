...
function _s_scripts() {
	...
	wp_enqueue_script( '_s-navigation', get_template_directory_uri() . '/library/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( '_s-skip-link-focus-fix', get_template_directory_uri() . '/library/js/skip-link-focus-fix.js', array(), '20151215', true );
...
function wpn_theme_styles() {
	wp_enqueue_style( 'cutom_css', get_template_directory_uri() . '/library/css/style.css' );
}
